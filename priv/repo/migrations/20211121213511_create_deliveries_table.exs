defmodule InBeauty.Repo.Migrations.CreateDeliveriesTable do
  use Ecto.Migration

  def change do
    create_query =
      "CREATE TYPE delivery_type AS ENUM ('sdek_pickup', 'sdek_courier', 'in_beauty_courier', 'in_beauty_pickup')"
