defmodule InBeautyWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: InBeautyWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/in_beauty_web/templates",
        namespace: InBeautyWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {InBeautyWeb.LayoutView, "live.html"}
