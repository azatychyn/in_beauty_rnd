defmodule InBeauty.Deliveries.Delivery do
  ...
  schema "deliveries" do
    ...
    field :delivery_type, Ecto.Enum,
      values: [:sdek_pickup, :sdek_courier, :in_beauty_courier, :in_beauty_pickup]
  ...
  def create_changeset(delivery, attrs \\ %{}) do
    delivery_point =
      (attrs["delivery_point"] || attrs[:delivery_point])
      |> IO.inspect()
  ...
  defp validate_by_delivery_type(changeset, delivery_type)
  ...
  defp validate_by_delivery_type(changeset, delivery_type)
       when delivery_type in ["in_beauty_pickup", :in_beauty_pickup] do
    changeset
  end

  defp validate_by_delivery_type(changeset, delivery_type)
       when delivery_type in ["sdek_pickup", :sdek_pickup] do
