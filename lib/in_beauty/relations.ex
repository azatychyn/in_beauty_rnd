defmodule InBeauty.Relations do
  ...
  @spec update_stock_cart(StockCart.t(), map()) ::
          {:ok, StockCart.t()} | {:error, Ecto.Changeset.t()}
  ...
  @spec update_stock_order(StockOrder.t(), map()) ::
          {:ok, StockOrder.t()} | {:error, Ecto.Changeset.t()}
  ...
  # @spec create_favorite_product(map()) ::
  #         {:ok, FavoriteProduct.t()} | {:error, Ecto.Changeset.t()}
  ...
  # @spec update_favorite_product(FavoriteProduct.t(), map()) ::
  #         {:ok, FavoriteProduct.t()} | {:error, Ecto.Changeset.t()}
  ...
  # @spec delete_favorite_product(FavoriteProduct.t()) ::
  #         {:ok, FavoriteProduct.t()} | {:error, Ecto.Changeset.t()}
  ...
  # def change_favorite_product(%FavoriteProduct{} = favorite_product),
  #   do: FavoriteProduct.changeset(favorite_product, %{})
end
